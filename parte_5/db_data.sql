-- 1) Insertar géneros (el ID se genera automáticamente)
...
-- 2) Insertar películas con UUIDs desde el JSON
INSERT INTO public.movies (id, title, year, director, duration, poster, rate) VALUES
  ...
  ('7e3fd5ab-60ff-4ae2-92b6-9597f0308d10', 'Gladiator',                     2000, 'Ridley Scott',           155, 'https://img.fruugo.com/product/0/60/14417600_max.jpg',                  8.5),
...
-- 3) Relacionar películas con géneros
INSERT INTO public."movie-genres" (movie_id, genre_id) VALUES
  -- Shawshank → Drama
  (
    'dcdd0fad-a94c-4810-8acc-5f108d3b18c3',
    (SELECT id FROM public.genres WHERE genre = 'Drama')
  ),

  -- Dark Knight → Action, Crime, Drama
  (
    'c8a7d63f-3b04-44d3-9d95-8782fd7dcfaf',
    (SELECT id FROM public.genres WHERE genre = 'Action')
  ),
  (
    'c8a7d63f-3b04-44d3-9d95-8782fd7dcfaf',
    (SELECT id FROM public.genres WHERE genre = 'Crime')
  ),
  (
    'c8a7d63f-3b04-44d3-9d95-8782fd7dcfaf',
    (SELECT id FROM public.genres WHERE genre = 'Drama')
  ...
  (
    '5ad1a235-0d9c-410a-b32b-220d91689a08',
    (SELECT id FROM public.genres WHERE genre = 'Adventure')
  ),
  (
    '5ad1a235-0d9c-410a-b32b-220d91689a08',
    (SELECT id FROM public.genres WHERE genre = 'Sci-Fi')
  ),
  ...
  (
    '9e6106f0-848b-4810-a11a-3d832a5610f9',
    (SELECT id FROM public.genres WHERE genre = 'Romance')
  ),

  -- Gladiator → Action, Adventure, Drama
  (
    '7e3fd5ab-60ff-4ae2-92b6-9597f0308d10',
    (SELECT id FROM public.genres WHERE genre = 'Action')
  ),
  (
    '7e3fd5ab-60ff-4ae2-92b6-9597f0308d10',
  ...
  -- The Return of the King → Action, Adventure, Drama
  (
  ...
  (
    ...
    (SELECT id FROM public.genres WHERE genre = 'Animation')
  ),
  (
    '2e6900e2-0b48-4fb6-ad48-09c7086e54fe',
    (SELECT id FROM public.genres WHERE genre = 'Adventure')
  ...
  (
    ...
    (SELECT id FROM public.genres WHERE genre = 'Biography')
  ),
  (
    '8fb17ae1-bdfe-45e5-a871-4772d7e526b8',
    (SELECT id FROM public.genres WHERE genre = 'Drama')
  ...
  (
    '6a360a18-c645-4b47-9a7b-2a71babbf3e0',
    (SELECT id FROM public.genres WHERE genre = 'Fantasy')
  )
